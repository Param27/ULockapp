...
public class SplashView extends View {
  ...
  public static final int DEFAULT_HOLE_FILL_COLOR = Color.rgb(0,150,136);
  public static final int DEFAULT_ICON_COLOR = Color.rgb(0,150,136);
  ...
  private void setupAttributes(AttributeSet attrs) {
    ...
    for (int i = 0; i < numAttrs; ++i) {
      ...
      switch (attr) {
      case R.styleable.TwitterSplashView_ticon:
